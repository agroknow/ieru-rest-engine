...
class OrganicAPI
{
    ...
    public function & get_search () 
    {
        ...
        $url = SERVER_ANALYTICS_URL.'/analyticsapi/search';
            ...
            foreach ( $uris as $uri ) 
            {
                try 
                {
                    ...
                    $sql = 'SELECT  string.Text as title, strings.Text as description, technical.format, identifier.entry_metametadata as entry, 
                            ...
                            WHERE identifier.entry_metametadata = ? AND string.FK_title is not NULL AND strings.FK_description is not NULL 
